...
$args = array(
    'posts_per_page' => 1,
    'category_name' => 'interfaith',
    // 'orderby' => 'rand'
);

$fourth_cat = new WP_Query($args); ?>

<?php if ($fourth_cat->have_posts() ) : while ($fourth_cat->have_posts() ) : $fourth_cat->the_post(); ?>
    ...
    <!-- <div class="cat-item col-xs-12 col-lg-6"> -->
        ...
        <div class="col-md-4 col-lg-3 hidden-sm-down">
            <?php
                if (in_category( array('interfaith') ) ){ ?>
